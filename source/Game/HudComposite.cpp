...
HudComposite::HudComposite(Core* core, Interface* ui, int* health, int* power, rect<s32> buttonPos, std::string* helpText) : Composite("HudComposite")
{
	_core = core;
	_interface = ui;
	...
	//hudHelpText = new HudHelpText(core, ui, helpText, irr::core::rect<s32>(50, 500, 90, 520));
}

HudComposite::~HudComposite()
{
}

void HudComposite::init() 
{
