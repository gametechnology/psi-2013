...
void SectorManager::init(){
	...
	Game::addScene(new SectorHomeBase(this,"skybox02.png",2000.0,_mapSector->connections.size()));
}
		...
		case NEXT_SECTOR: //Switch Sector 
			...
			switch (_mapSector->type){ 
				case EMPTY:
					...
					Game::addScene(new BaseSector(this,"skybox02.png",2000.0,_mapSector->connections.size()));
					break;
				case ASTEROID:
					printf("[SectorTemplate] ASTEROID \n");
					//delete _currentSector;
					Game::addScene(new AsteroidSector(this,"skybox02.png",2000.0,_mapSector->connections.size()));
					break;
				case NEBULA:
					printf("[SectorTemplate] NEBULA \n");
					//delete _currentSector;
					Game::addScene(new NebulaSector(this,"skybox02.png",2000.0,_mapSector->connections.size()));
					break;
				case SOLAR: 
